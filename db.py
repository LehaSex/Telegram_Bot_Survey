...
def init_db():
    ...
    db_cursor.execute("CREATE TABLE IF NOT EXISTS questions (id INTEGER PRIMARY KEY AUTOINCREMENT, question_text TEXT, question_answers TEXT, question_text_ent TEXT, question_photo TEXT)")
    ...
    db_cursor.execute("CREATE TABLE IF NOT EXISTS content (id INTEGER PRIMARY KEY AUTOINCREMENT, content_text TEXT, content_text_ent TEXT, content_photo TEXT, content_video TEXT, content_audio TEXT, content_document TEXT, on_answer TEXT, published INTEGER DEFAULT 0, published_date TEXT, published_by INTEGER REFERENCES users (chat_id))")
